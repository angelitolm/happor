...
class WebBuilder extends Builder
{
    ...
    /** @var string logo-small-happor.png file name. */
    private $filename;
    ...
    public function dump(array $packages)
    {
        ...
        $origen = $this->outputDir . '/../views/assets/others/logo-small-happor.png';
        $destino = $this->filename = $this->outputDir . '/logo-small-happor.png';
        copy($origen, $destino);

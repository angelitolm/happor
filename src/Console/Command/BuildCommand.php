...
namespace Composer\Happor\Console\Command;
...
use Composer\Happor\Builder\ArchiveBuilder;
use Composer\Happor\Builder\PackagesBuilder;
use Composer\Happor\Builder\WebBuilder;
use Composer\Happor\Console\Application;
use Composer\Happor\PackageSelection\PackageSelection;
...
class BuildCommand extends BaseCommand
{
    protected function configure()
    {
        $this
            ...
            ->setDefinition([
                new InputArgument('file', InputArgument::OPTIONAL, 'Json file to use', './happor.json'),
...
(happor.json is used by default) and outputs a composer
...
- <info>"require-dependencies"</info>: if you mark a few packages as
  ...
  to true will make happor automatically require all of your
...
- <info>"archive"</info> archive configuration, see https://getcomposer.org/doc/articles/handling-private-packages-with-happor.md#downloads
...
EOT
     ...
     * according to happor-schema.json rules.
     *
    ...
    private function check($configFile)
    {
        ...
        if (null === $result) {
            ...
            $schemaFile = __DIR__ . '/../../../res/happor-schema.json';

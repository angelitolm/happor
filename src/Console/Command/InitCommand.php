...
class InitCommand extends BaseCommand
{
    protected function configure()
    {
        $this
            ->setName('init')
            ->setDescription('Initialize Happor configuration file')
            ->setDefinition([
            ...
            ->setHelp(<<<'EOT'
The <info>init</info> generates configuration file (happor.json is used by default).
...
EOT
    ...
    protected function initialize(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln([
            '',
            $formatter->formatBlock('Welcome to the Happor config generator', 'bg=blue;fg=white', true),
            '',
        ]);

        $output->writeln([
            '',
            'This command will guide you through creating your Happor config.',
            '',
        ]);
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln([
            ...
            'Use <comment>happor add repository-url</comment> to add them.',
            '',
        ]);

...
<p>Simple static Composer repository generator.</p>
...
<ul>
<li>Install satis: <code>composer create-project composer/satis:dev-master</code></li>
<li>Build a repository: <code>php bin/satis build &lt;configuration-file&gt; &lt;output-dir&gt;</code></li>
</ul>
...
<p>Pull the image:</p>
<div class="highlight highlight-source-shell"><pre>docker pull composer/satis</pre></div>
<p>Run the image:</p>
<div class="highlight highlight-source-shell"><pre>docker run --rm -it -v /build:/build composer/satis</pre></div>
<blockquote>
...
<div class="highlight highlight-source-shell"><pre>docker run --rm -it -v /build:/build -v <span class="pl-smi">$COMPOSER_HOME</span>:/composer composer/satis</pre></div>
...
<div class="highlight highlight-source-shell"><pre>docker run --rm -it --entrypoint /bin/sh composer/satis</pre></div>
...
<h2><a id="user-content-community-tools" class="anchor" aria-hidden="true" href="#community-tools"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Community Tools</h2>
<ul>
<li><a href="https://github.com/benschw/satis-go">satis-go</a> - A simple web server for managing Satis configuration and
hosting the generated Composer repository.</li>
...
<li><a href="https://github.com/realshadow/satis-control-panel">satis-control-panel</a> - Simple web UI for managing your Satis Repository
with optional CI integration.</li>
<li><a href="https://github.com/AOEpeople/composer-satis-builder">composer-satis-builder</a> - Simple tool for updating the Satis configuration
(satis.json) "require" key on the basis of the project composer.json.</li>
</ul>
<h2><a id="user-content-license" class="anchor" aria-hidden="true" href="#license"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>License</h2>
<p>Satis is licensed under the MIT License - see the <a href="https://github.com/composer/satis/blob/master/LICENSE">LICENSE</a> file for details</p>

...
(function ($) {
    ...
    BootstrapTable.prototype.initContainer = function () {
        this.$container = $([
            ...
            '</div>',
            '</div>',
            '<div class="footer-paginator"><table><tr></tr></table></div>',
        ...
        this.$tableContainer = this.$container.find('.package-list');
        this.$tableHeader = this.$container.find('.fixed-table-header');
        this.$tableBody = this.$container.find('.panel-info');
        this.$tableLoading = this.$container.find('.fixed-table-loading');
        this.$tableFooter = this.$container.find('.fixed-table-footer');
        this.$toolbar = this.$container.find('.footer-paginator');
